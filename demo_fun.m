function [label_lap, NCut_lap, label_inhomo, NCut_inhomo] = demo_fun(...
...
[label_lap, incidence_partition_lap, NCut_lap, v_lap] = clique_exp(incidence_list, parameter_list, submodular_type, N, R);
